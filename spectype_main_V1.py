...
if teff_ini >= 6000:
    logg_regions = [[3850,3900],[5140,5235]]
...
if len(logg_regions[0]) == 0:
    ...
    if teff_ini >= 6000:
        flux_regions = [logg_regions[0]]
        norm_regions = logg_regions[1:]

        array1 = calculate_chisq_from_input_regions("flux",flux_spectrum,teff_ini,logg_ini,feh_ini,flux_regions)
        array2 = calculate_chisq_from_input_regions("norm",norm_spectrum,teff_ini,logg_ini,feh_ini,norm_regions)
        master_norm_array = array1 + array2
